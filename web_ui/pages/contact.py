...
def contact_form_box() -> rx.Component:
    """Contact form component (reusable for mobile and desktop)"""
    return rx.box(
        rx.cond(
...
def contact_info_vstack() -> rx.Component:
    """Contact info component (reusable for mobile and desktop)"""
    return rx.vstack(
        rx.heading(
            "Get in Touch",
            size="6",
    ...
    return rx.vstack(
        ...
        rx.box(
            rx.box(
                ...
                # Mobile layout (form on top, stacked vertically)
                rx.box(
                    rx.vstack(
                        contact_form_box(),
                        contact_info_vstack(),
