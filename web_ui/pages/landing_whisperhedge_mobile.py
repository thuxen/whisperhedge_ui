    ...
    return rx.vstack(
        ...
        rx.box(
            rx.vstack(
                ...
                rx.hstack(
                    rx.heading("$0", size="5", weight="bold", color=COLORS.TEXT_PRIMARY),
                ...
                rx.text("$2,500 Included TVL", size="2", weight="bold", color=COLORS.TEXT_PRIMARY, margin_bottom="0.5rem"),
                rx.vstack(
                    rx.text("✓ TVL Hard Cap", size="2", color=COLORS.TEXT_SECONDARY),
        ...
        rx.box(
            rx.vstack(
                ...
                rx.hstack(
                    rx.heading("$19.99", size="5", weight="bold", color=COLORS.TEXT_PRIMARY),
                    rx.text("/mo", size="2", color=COLORS.TEXT_SECONDARY),
                    align="end",
                    spacing="1",
                    margin_bottom="1rem",
                ...
                rx.divider(margin_y="0.5rem"),
                rx.text("$10,000 Included TVL", size="2", weight="bold", color=COLORS.TEXT_PRIMARY),
        ...
        rx.box(
            rx.vstack(
                ...
                rx.hstack(
                    rx.heading("$49.99", size="5", weight="bold", color=COLORS.TEXT_PRIMARY),
                    rx.text("/mo", size="2", color=COLORS.TEXT_SECONDARY),
                    align="end",
                    spacing="1",
                    margin_bottom="1rem",
                ...
                rx.divider(margin_y="0.5rem"),
                rx.text("$50,000 Included TVL", size="2", weight="bold", color=COLORS.TEXT_PRIMARY),
        ...
        rx.box(
            rx.vstack(
                ...
                rx.hstack(
                    rx.heading("$89.99", size="5", weight="bold", color=COLORS.TEXT_PRIMARY),
                    rx.text("/mo", size="2", color=COLORS.TEXT_SECONDARY),
                    align="end",
                    spacing="1",
                    margin_bottom="1rem",
                ...
                rx.divider(margin_y="0.5rem"),
                rx.text("$150,000 Included TVL", size="2", weight="bold", color=COLORS.TEXT_PRIMARY),
                rx.text("0.05% (5 bps) on excess", size="1", color=COLORS.TEXT_MUTED, font_style="italic", margin_bottom="0.5rem"),
                rx.vstack(
        ...
        rx.box(
            rx.vstack(
                ...
                rx.hstack(
                    rx.heading("$199.99", size="5", weight="bold", color=COLORS.TEXT_PRIMARY),
                    rx.text("/mo", size="2", color=COLORS.TEXT_SECONDARY),
                    align="end",
                    spacing="1",
                    margin_bottom="1rem",
                ...
                rx.divider(margin_y="0.5rem"),
                rx.text("$500,000 Included TVL", size="2", weight="bold", color=COLORS.TEXT_PRIMARY),
                rx.text("0.05% (5 bps) on excess", size="1", color=COLORS.TEXT_MUTED, font_style="italic", margin_bottom="0.5rem"),
                rx.vstack(
        ...
        rx.vstack(
            rx.hstack(
                rx.html("<svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24' fill='none' stroke='rgba(16, 185, 129, 0.8)' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='m9 12 2 2 4-4'></path><circle cx='12' cy='12' r='10'></circle></svg>"),
                rx.text(
            ...
            rx.hstack(
                rx.html("<svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24' fill='none' stroke='rgba(16, 185, 129, 0.8)' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8'></path><path d='M3 3v5h5'></path></svg>"),
                rx.text(
            ...
            rx.hstack(
                rx.html("<svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24' fill='none' stroke='rgba(16, 185, 129, 0.8)' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z'></path><path d='m9 12 2 2 4-4'></path></svg>"),
                rx.text(
