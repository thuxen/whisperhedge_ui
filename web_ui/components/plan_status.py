        ...
        rx.vstack(
            ...
            rx.vstack(
                rx.hstack(
                    ...
                    rx.cond(
                        PlanStatusState.has_position_override,
                        rx.badge(
                            "Override",
                            color_scheme="orange",
                            size="1",
                ...
                rx.hstack(
                    rx.text(
                        PlanStatusState.current_positions,
                        size="3",
                        weight="bold",
                        color=rx.cond(
                            PlanStatusState.is_near_position_limit,
                            "#F59E0B",  # amber
                            COLORS.TEXT_PRIMARY,
                        ),
                    ),
                    rx.text(
                        rx.text.span(" / ", PlanStatusState.position_limit_display),
                        size="2",
                        color=COLORS.TEXT_MUTED,
                    ),
                    spacing="1",
                ...
                rx.box(
                    rx.box(
                        width=f"{PlanStatusState.position_percentage}%",
                        height="100%",
                        background=rx.cond(
                            PlanStatusState.is_near_position_limit,
                            "#F59E0B",  # amber
